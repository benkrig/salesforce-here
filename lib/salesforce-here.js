...
*/
var uploadZip = function (params)
{
	var binaryObj = new Buffer(params.zipFile, 'base64');
	var s3obj = new aws.S3({params: {Bucket: 'here2there', Key: params.userid}});
...
/*
	...
	*/
var testfun = function(params, callback)
{
	...
	*/
	newPackageDotXML: function(metadata, callback)
	{
		if(metadata.xmlnames.length > 0)
		{
			...
			testfun(metadata, function(namearray)
			{
				package.types.push(
				{
